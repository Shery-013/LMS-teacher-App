...
const AttendanceScreen = ({ navigation }) => {
    ...
    const boxes = [
        { id: 1, icon: 'addusergroup', label: 'Class Attendance', screen: 'AddAttendance' },
        { id: 2, icon: 'search1', label: 'Search Attendance', screen: 'SearchAttandance' },
        { id: 10, icon: 'linechart', label: 'Montly Attendance', screen: 'MontlyAttandance' },
    ...
    return (
        <View>
            <View style={styles.container}>
               ...
               <Text style={styles.topHeading}>Attendance</Text>
            </View>
